      ...
      <div>
        ...
        <Router>
          <Switch>
            ...
            <Route key={0} exact path="/may-anh-dslr" component={()=>(<Index type={1} />)} />
            <Route key={0} exact path="/may-anh-mirror-less" component={()=>(<Index type={2} />)} />
            <Route key={0} exact path="/may-anh-du-lich" component={()=>(<Index type={3} />)} />
