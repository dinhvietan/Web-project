...
class ProductDetail extends React.Component {
    ...
    buidDescription() {
        ...
        if(this.state.info != null) {
            ...
            let HeaderProduct = (
                <div>
                    <h4>{this.state.info.inventory_name}</h4>
                    <Button className="product-detail-tool product-detail-edit"><a href="javascript:void(0)" onClick={this.editHandle.bind(this)}>Chỉnh Sửa</a></Button>
                    <Button className="product-detail-tool product-detail-delete"><a href="javascript:void(0)" onClick={this.removeHandle.bind(this)}>Xóa</a></Button>
                </div>
            );
    ...
    render() {
        ...
        if(this.state.isEdit === true) {
            ...
            return (
                <div>
                    <Panel className="page-panel product-detail">
                        <Panel.Heading>
