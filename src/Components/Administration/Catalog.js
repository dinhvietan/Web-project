        ...
        if(this.state.info != null) {
            let Headerbrand = (
                <div>
                    ...
                    <Button className="catalog-detail-tool catalog-detail-edit"><a href="javascript:void(0)" onClick={this.editHandle.bind(this)}>Chỉnh Sửa</a></Button>
                    <Button className="catalog-detail-tool catalog-detail-delete"><a href="javascript:void(0)" onClick={this.removeHandle.bind(this)}>Xóa</a></Button>
                </div>
            );
