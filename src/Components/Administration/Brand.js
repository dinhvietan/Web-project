...
class Brand extends React.Component {
    ...
    buidDescription() {
        ...
        if(this.state.info != null) {
            let Headerbrand = (
                <div>
                    <h4>{this.state.info.brand_name}</h4>
                    <Button className="brand-detail-tool brand-detail-edit"><a href="javascript:void(0)" onClick={this.editHandle.bind(this)}>Chỉnh sửa</a></Button>
                    <Button className="brand-detail-tool brand-detail-delete"><a href="javascript:void(0)" onClick={this.removeHandle.bind(this)}>Xóa</a></Button>
                </div>
            );
                ...
                <div key={1}>
                    <ListGroup>
                        <ListGroupItem className="brand-detail-des-name" header={Headerbrand}>
                            <h4>Công ty: <span className="brand-detail-des-company">{this.state.info.brand_company}</span></h4>
                        </ListGroupItem>
                        <ListGroupItem header="">
                            <h4 dangerouslySetInnerHTML={{__html:this.state.info.brand_description}}></h4>
                        </ListGroupItem>
                    </ListGroup>
                </div>
            );
            ...
            <div className="brand-detail">
                <Grid fluid={false}>
                    <Row className="show-grid">
                        ...
                        <Col className="brand-detail-des" xs={12} sm={12} md={12}>
                            {desTemplate}
                        </Col>
                    </Row>
                </Grid>
